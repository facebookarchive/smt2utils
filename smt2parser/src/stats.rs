...
impl CommandVisitor<Term, Symbol, Sort, Keyword, Constant, SExpr> for StatsHolder {
    ...
    fn visit_echo(&mut self, _value: String) -> Self::T {}
    ...
    fn visit_get_info(&mut self, _info_flag: Keyword) -> Self::T {}

    fn visit_get_model(&mut self) -> Self::T {}

    fn visit_get_option(&mut self, _option: Keyword) -> Self::T {}
    ...
    fn visit_pop(&mut self, _num: Numeral) -> Self::T {}

    fn visit_push(&mut self, _num: Numeral) -> Self::T {}

    fn visit_reset(&mut self) -> Self::T {}

    fn visit_reset_assertions(&mut self) -> Self::T {}

    fn visit_set_info(&mut self, _key: Keyword, _value: AttributeValue) -> Self::T {}

    fn visit_set_logic(&mut self, _name: Symbol) -> Self::T {}

    fn visit_set_option(&mut self, _key: Keyword, _value: AttributeValue) -> Self::T {}
}
